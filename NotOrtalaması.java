...
public class NotOrtalaması extends javax.swing.JFrame {

    /**
     * String isim = jTextField1.getText(); int no =
     * Integer.parseInt(jTextField2.getText()); int vize =
     * Integer.parseInt(jTextField3.getText()); int finalnotu =
     * Integer.parseInt(jTextField4.getText()); int proje =
     * Integer.parseInt(jTextField5.getText());
     *
     * Creates new form NotOrtalaması
     */
    ArrayList<Öğrenciler> Array = new ArrayList<>();

    public NotOrtalaması() {
        initComponents();
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int finalnotu = Integer.parseInt(jTextField4.getText());
        int proje = Integer.parseInt(jTextField5.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotOrtalaması.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotOrtalaması().setVisible(true);
            }
        });
    }
